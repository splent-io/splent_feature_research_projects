"""
Template hooks for splent_feature_research_projects.
...
Examples:
    ...
    def research_projects_scripts():
        return (
            '<script src="'
            + url_for("research_projects.assets", subfolder="dist", filename="splent_feature_research_projects.bundle.js")
            + '"></script>'
        )

    register_template_hook("layout.scripts", research_projects_scripts)
"""
